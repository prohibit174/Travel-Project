  ...
  <body>
    ...
    /* Map 관련 변수 */
     ...
     /* Calendar 관련 변수 */  
   		...
   		currentDate.setMonth(currentDate.getMonth()+1);//현재 날짜는  
   		currentDate.setDate(currentDate.getDate()+2);
   		
   		
   		function LongDateToShortDate(longDate){// longDate -> ShortDate
   		 ...
   		 function ShortDateToLongDate(shortDate){// ShortDate -> longDate  
   			tempDate=new Date();
      ...
      function initMap() {
    	...
    	for(i=0;i<marker_zoom4.length;i++)
		{
			marker_zoom4[i].addListener('click', function() {
				...
				var StartDate=LongDateToShortDate(currentDate);//longdate를 shortStartDate로 저장
				alert(currentDate);
				//endDate 설정
				currentDate.setDate(currentDate.getDate()+2);	//기준 일 +2 
				var EndDate=LongDateToShortDate(currentDate);//endDate를 기준 일 +2로 설정
