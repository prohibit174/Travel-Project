...
<meta property="og:title" content="해피머니상품권 배송"/>
...
<meta property="og:description" content="10만원권 8% 할인! 선물로 강추!"/>
...
<div id="wrap" heatmap:ignore="1">
        ...
        <div id="inner_wrap">
        <!-- 마케팅 기획전의 경우, 상단 네비게이션 숨김
             통합 기획전의 경우, 상단 네비게이션 노출여부에 따라 노출 -->
                    <div class="spot">
...
function notifyCouponDealInfo()
{
    ...
    $.getJSON('/coupon/notify', params, function (output) {
        ...
        if (maxCouponMinBuy > 0 && maxCoupon > 0) {
            $('#coupon_guide_inner').html('<nobr>쿠폰으로 <strong class="pr">할인</strong> 받으세요!</nobr>');
...
<script id="viewUserViewTemplate" type="text/x-jquery-tmpl">	<li>
		...
		<div class="detail">
			...
			<div class="amounts">
				<div class="price">
					{{if orgprice_view}}
						<!--// orgprice_view 가 Y인 경우(공동 기획가, 티몬가) //-->
						{{if orgprice_title == '공동 기획가'}}
							<p class="sale"><span class="blind">공동 기획가</span><em>${deal_disamount_number_format}</em>원</p>
						{{else}}
							<p class="sale"><span class="blind">티몬가</span><em>${deal_disamount_number_format}</em>원</p>
						{{/if}}
					{{else}}
						<p class="sale"><span class="blind">할인가</span><em>${deal_disamount_number_format}</em>원</p>
						{{if deal_disrate > 0}}
						<p class="prime"><span class="blind">정상가</span><em>${deal_amount_number_format}</em>원</p>
						{{/if}}
					{{/if}}
				</div>
			</div>
...
<script id="similarLayerTemplate" type="text/x-jquery-tmpl">	{{if tl_ord > 5}}
	...
	{{/if}}
		<a href="${url}" tl:area="SICO" tl:ord="${tl_ord}" tl:linktype="img">
			...
			<span class="people"><em>${deal_buy_count}</em>명 구매</span>
		</a>
	</li>
</script>
<script id="similarLayerUlTemplate" type="text/x-jquery-tmpl">	<div class="similar_pd_ct" id="similar_pd_ct" style='display:block'>
		...
		<p class="tit">비슷한 상품 보기</p>
		<p class="page"><strong>${view_cur_page}</strong>/${view_total_page}</p>
		<ul class="similar_pd_lst" id="similarLayerLiUl">
		</ul>
		<div class="loading" style="display:block" id="similarLoading"><img src="http://image.ticketmonster.co.kr/static/img/ajax-loader.gif" width="32" height="32" alt="로딩중"></div>
		<a style="cursor:pointer" id="si_btn_prev" class="btn_prev" tl:area="SICO" tl:ord="0" tl:linktype="prev"><span>이전 상품</span></a>
		<a style="cursor:pointer" id="si_btn_next" class="btn_next" tl:area="SICO" tl:ord="0" tl:linktype="next"><span>다음 상품</span></a>
	</div>
		...
		success:function(data){
			if(data != null && data.coupon_srl != null && data.coupon_srl > 0) {
                ...
                if(data.coupon_type == "DELIVERY") {
                    ...
                    discountStr = $.number_format(discountPercent) + "% 할인";
                } else {
					...
					discountStr = $.number_format(discountAmount) + "원 할인";
				}
...
<link href="http://static2.tmon.kr/static/gen/css/jquery.jqzoom.css?v=0662945f6041df0748663a319955ef132fa97499" rel="stylesheet" type="text/css"/>
                ...
                <div class="img_area">
                    ...
                    <div class="review_result">
                        <dl>
                            <dt>상품</dt>
                            <dd><span style="width:96%">4.8점</span></dd>
							                            <dt>배송</dt>
                            <dd><span style="width:96%">4.8점</span></dd>
							
                        </dl>
                        <a href="/userReview/548520330/14090000/14090001/#content_start">후기 <em>343</em>건<span class="bu"></span></a>
                    </div>
                                                        </div>                 <!-- WEB-3705 by dwkang <div class="alimipop" id="alarmpop" style="display:none;"></div> -->                 <div class="ct_area">
                    <div class="deal_info">
                                                    </div>
                                            <p class="stit">10만원권 8% 할인! 선물로 강추!</p>
                    <h3 class="tit">지류상품권으로 배송되는<br />
[ 해피머니 상품권 ]<br />
</h3>
               <div id="promotion_block">
                    <div id="price_info" class="price_info">
                            ...
                            <div class="old">
                                ...
                                <em>
                                    100,000<span class="won">원</span><span class="line"></span>
                                </em>
                                                                    <a style="cursor:pointer" class="btn_price" id="btn_price">
                                        <span class="inner">홈페이지 판매가<span>?</span></span>
                                    </a>
                                    <div class="price_guide" id="price_guide" style="display:none">
                                        <div class="inner">
                                            <span class="bu"></span>
                                            <strong>홈페이지 판매가</strong>
                                            매장에서 운영하는 홈페이지 상에 표시된 가격을 기준으로 합니다.                                        </div>
                                    </div>
...
<span class="no9">9</span><span class="no2">2</span><span class="comma">,</span><span class="no0">0</span><span class="no0">0</span><span class="no0">0</span><span class="won">원</span></strong>
                        </div>
                        ...
                        <div class="menu_lst" id="menu_lst">
							<a class="btn_viewcp _eventCoupon _act" tl:area="DDIA" tl:ord="1" style="cursor:pointer;display:none;" id="couponA">
								...
								<span class="btn download">다운로드</span>
                                                            ...
                                                            <span class="bar">|</span>
                                <em><img src="http://img2.tmon.kr/static/img/img_discount3.gif" width="28" height="21" alt="무료배송"></img>
무료배송</em>
                        ...
                        <span class="stock">현재<strong class="num buycount">0</strong>
                            <span class="txt2">개 구매</span>
                        </span>
                        <span class="bar">|</span>
                                                                                    <span class="time">
                                    남은시간<strong id="rest_time"></strong><span class="day" style="display:none;">일</span>
                                </span>
                    ...
                    <!-- 상품 옵션 //-->
                        ...
                        <span class="second_opt_msg" style="display:none">추가 구매하시려면, 옵션을 한번 더 선택해 주세요.</span> 
                                                    <span>(1인당 최대 <span>10</span>개, <em>무료배송</em>)</span>
                    ...
                    <div class="option_info2">
                        ...
                        <li>
                                                ...
                                                <span class="option">
                            해피머니상품권 10만원                                                            <span class="bar">|</span>17,421개 남음
                                                            </span>
                            <span class="uio_option_cnt">
                                ...
                                <a dealsrl="550207546" mincnt="17421" mincnt_buywait="10" class="uio_btn_plus" style="cursor:pointer">증가</a>
                                <a dealsrl="550207546" mincnt="17421" mincnt_buywait="10" class="uio_btn_minus" style="cursor:pointer">감소</a>
                                </span>
                            </span>
                                                            <span class="total"><em id="opt_amt_550207546">92,000</em>원</span>
                    ...
                    <dummy sg:else>-->
                        ...
                        <div class="btn_area default">
                                                            <div class="btn_direct"><a id="buy_button" href="#buy">바로구매</a></div>                                                                                                    
                            
                            <div                                class="click_zzim z_548520330">
                                <input type="hidden" id="zzim_count" value="1414"><a id="deal_zzim" class="btn_zzim " style="cursor:pointer" value="548520330" tl:area="BWCO" tl:ord="2">찜하기</a><strong class="hits" ><em id="zzim_cnt">1,414</em></strong>
                            </div>
                        </div>
                ...
                <div class="lpop_wrap2" id="standby_alert" style="display:block;top:50%;z-index:1110;margin-top:-155px;display:none">
                    <div class="lpop_cont">
                        ...
                        <div class="caution_area">
                            <em class="h_caution"><span class="bu"></span>구매시 유의사항</em>
                    ...
                    <a style="cursor:pointer" id="lpop_btn_close_new" class="btn_clse">레이어 닫기</a>
                </div>
