			...
			<div>
				<div class="nlogin_policy_wrap">
					...
					<!-- style="display: none;" -->
						...
						<div class="policy_content">
							...
							<span>이 서비스 이용약관(이하 “약관”이라 합니다)은 ㈜투어팁스(이하 “회사”라 합니다)가 제공하는
								서비스와 관련하여 회사와 회원 간에 서비스의 이용 조건 및 절차, 회사와 회원 간의 권리, 의무 및 책임 사항 기타
								필요한 사항을 규정함을 목적으로 합니다.</span>
							<p class="private_list_title">제2조 [용어의 정의]</p>
							<p>이 약관에서 사용하는 용어의 정의는 다음과 같습니다.</p>
							<ol>
								<li>서비스: 이용 고객 또는 회원이 PC, TV, 휴대형 단말기 등 각종 유무선 기기 또는 프로그램을
									통하여 이용할 수 있도록 회사가 제공하는 모든 인터넷 서비스를 말하며, 회사가 공개한 API를 이용하여 제3자가
									개발 또는 구축한 프로그램이나 서비스를 통하여 회원에게 제공되는 경우를 포함합니다.</li>
								<li>회원: 회사의 서비스에 접속하여 이 약관에 따라 회사와 이용 계약을 체결하고 회사가 제공하는
									서비스를 이용하는 고객을 말합니다.</li>
								<li>이메일: 인터넷을 통한 우편 혹은 전기적 매체를 이용한 우편을 말합니다. 또 회원의 식별과 서비스
									이용을 위하여 회원이 정하는 아이디(ID)처럼 사용하는 것을 의미합니다.</li>
								<li>비밀번호: 회원이 부여받은 아이디와 일치되는 회원임을 확인하고 비밀보호를 위해 회원 자신이 정한
									문자 또는 숫자의 조합을 의미합니다.</li>
								<li>게시물: 회원이 서비스를 이용함에 있어 서비스상에 게시한 부호∙문자∙음성∙음향∙화상∙동영상 등의
									정보 형태의 글,사진,동영상 및 각종 파일과 링크 등을 의미합니다.</li>
								<li>운영자(관리자): 서비스의 전반적인 관리와 원활한 운영을 위하여 회사에서 선정한 사람 또는 회사를
									말합니다.</li>
								<li>가이드북과 맵북: 다운로드 받을 수 있는 PDF형태의 문서로 회사에서 회원에게 제공하는 서비스를
									의미합니다. 이는 회원이 다운로드 받아 인쇄하여 사용이 가능하고 회사에서도 배포가 가능합니다.</li>
							</ol>
							<p class="private_list_title">제3조 [약관의 효력 및 변경]</p>
							<ol>
								<li>이 약관은 서비스 화면에 게시하거나 기타의 방법으로 회원에게 공지함으로써 효력이 발생합니다.</li>
								<li>회사는 약관의 규제에 관한 법률, 전자상거래 등에서의 소비자보호에 관한 법률, 정보통신망 이용촉진
									및 정보보호 등에 관한 법률 등 관계법령에 위배되지 않는 범위 내에서 이 약관을 개정할 수 있습니다.</li>
								<li>회사는 약관을 개정할 경우 그 개정 이유 및 적용 일자를 명시하여 현행 약관과 함께 적용일자
									7일전부터 적용일 전일까지 제1항의 방법으로 공지합니다. 다만, 회원의 권리 또는 의무에 관한 중요한 규정의
									변경은 최소한 30일 전에 공지하고 개정약관을 회원이 등록한 메일로 발송하여 통지합니다.</li>
								<li>회원은 변경된 약관에 동의하지 아니하는 경우 서비스의 이용을 중단하고 이용계약을 해지할 수 있습니다</li>
								<li>회원은 약관의 변경에 대하여 주의의무를 다하여야 하며, 변경된 약관의 부지로 인한 회원의 피해는
									회사가 책임지지 않습니다.</li>
							</ol>
							<p class="private_list_title">제4조 [약관의 해석]</p>
							<span>이 약관에 명시되지 않은 사항에 대해서는 정보통신망 이용촉진 및 정보보호 등에 관한 법률,
								약관의 규제에 관한 법률, 전기통신사업법 등 관계법령 및 회사가 정한 세부이용지침 등의 규정에 따릅니다.</span>
							<p class="private_list_title">제5조 [이용계약체결]</p>
							<ol>
								<li>서비스 이용계약은 이용고객이 이 약관 및 “개인정보처리방침”에 “동의합니다”를 선택하고, 회사가
									정한 신청양식을 작성하여 서비스의 이용을 신청한 후, 회사가 이를 승낙함으로써 성립합니다 이용고객이 전항의
									“동의합니다”를 선택하고 신청양식을 작성하는 것은 이 약관 및 “개인정보처리방침”의 내용을 숙지하고, 회사가
									서비스 이용을 위해 운영하는 각종 정책(예: 저작권 정책, 스팸 정책 등)과 수시로 공지하는 사항을 준수하는 것에
									대해 동의하는 것으로 봅니다.</li>
							</ol>
							<p class="private_list_title">제6조 [이용신청]</p>
							<ol>
								<li>회원이 신청양식에 기재하는 회원정보는 이용고객의 실제정보인 것으로 간주되고, 실제정보를 입력하지
									않은 회원은 법적인 보호를 받을 수 없으며 서비스 이용에 제한을 받을 수 있습니다.</li>
								<li>만14세 미만의 아동은 회사가 제공하는 서비스를 이용할 수 없습니다.</li>
								<li>타인의 개인정보를 도용하는 등 부정한 목적과 방법으로 이용신청을 한 회원의 ID는 사전 통지없이
									삭제될 수 있으며, 당해 회원은 관계 법령에 따라 처벌을 받을 수 있습니다.</li>
							</ol>
							<p class="private_list_title">제7조 [이용신청에 대한 승낙 및 제한]</p>
							<ol>
								<li>회사는 서비스의 이용을 신청한 이용고객에 대하여 업무상ㆍ기술상 지장이 없는 한 접수순서에 따라
									서비스의 이용을 승낙합니다.</li>
								<li>회사는 다음 각 호에 해당하는 이용신청에 대하여는 승낙을 하지 않을 수 있습니다.
									<ol>
										...
										<li>회원의 귀책사유에 의하여 회원자격을 상실한 적이 있는 경우. 다만, 자격상실 후 6개월 이상
											경과한 자로 회사의 회원 재가입 승낙을 받은 경우는 예외로 합니다.</li>
										<li>기타 회사가 정한 이용조건에 충족되지 않았을 경우</li>
									</ol>
								</li>
								<li>회사는 서비스를 이용하는 회원에 대하여 회원의 종류 및 등급별로 구분하여 이용시간, 이용회수,
									서비스 메뉴 등을 세분하여 이용에 차등을 둘 수 있습니다.</li>
							</ol>
							<p class="private_list_title">제8조 [회원정보의 변경]</p>
							<ol>
								<li>회원은 개인정보관리화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만,
									서비스 관리를 위해 필요한 아이디 등은 수정이 불가합니다.</li>
								<li>회원은 회원가입신청 시 기재한 사항이 변경되었을 경우 온라인으로 수정을 하거나 이메일 등 기타
									방법으로 회사에 그 변경 사항을 알려야 합니다.</li>
								<li>제 2항의 변경사항을 회사에 알리지 않아 발생한 불이익에 대하여 회사는 책임지지 않습니다.</li>
							</ol>
							<p class="private_list_title">제9조 [서비스의 이용]</p>
							<ol>
								<li>회사는 회원의 이용신청을 승낙한 때부터 서비스를 개시합니다. 다만, 일부 서비스의 경우에는 지정된
									일자부터 서비스를 개시합니다.</li>
								<li>회사의 업무상ㆍ기술상의 장애로 인하여 서비스를 개시하지 못하는 경우에는 서비스에 공지하거나 회원에게
									이를 통지합니다.</li>
								<li>서비스의 이용은 연중무휴 1일 24시간을 원칙으로 합니다. 다만, 회사의 업무상ㆍ기술상 또는 서비스
									운영정책상 서비스가 일시 중지될 수 있습니다. 이러한 경우 회사는 사전 똔느 사후에 이를 공지합니다.</li>
							</ol>
							<p class="private_list_title">제10조[“회원”의 “아이디(이메일)” 및 “비밀번호”의
								관리에 대한 의무]</p>
							<ol>
								<li>회원의 아이디(이메일)와 비밀번호에 관한 관리책임은 회원에게 있으며, 이를 제3자가 이용하도록
									하여서는 안됩니다.</li>
								<li>회원은 아이디(이메일)및 비밀번호가 도용되거나 제3자가 사용하고 있음을 인지한 경우에는 이를 즉시
									회사에 통지하고 회사의 안내에 따라야 합니다.</li>
								<li>제2항의 경우 해당 회원이 회사에 그 사실을 통지하지 않거나, 통지한 경우에도 회사의 안내에 따르지
									않아 발생한 불이익에 대하여 회사는 책임지지 않습니다.</li>
							</ol>
							<p class="private_list_title">제11조[“회원”에 대한 통지]</p>
							<ol>
								<li>회사가 회원에 대한 통지를 하는 경우 본 약관에 별도 규정이 없는 한 회원이 지정한 이메일 주소,
							...
							<ol>
								<li>회사는 관련법과 본 약관이 금지하거나 미풍양속에 반하는 행위를 하지 않으며, 계속적이고 안정적으로
									서비스를 제공하기 위하여 최선을 다하여 노력합니다.</li>
								<li>회사는 서비스 제공과 관련하여 알고 있는 회원의 정보를 본인의 동의 없이 제3자에게 제공하지
									않습니다.</li>
								<li>회사는 회원의 회원정보를 보호하기 위해 보안시스템을 구축 운영하며, “개인정보처리방침”을 공지하고
									준수합니다. 또한, 회사는 “개인정보처리방침”에 따라 회원 정보를 취급함에 있어 안정성 확보에 필요한 기술적,
									관리적 대책을 수립하고 운영합니다</li>
								<li>회사는 서비스와 관련한 회원의 불만사항이 접수되는 경우 이를 신속하게 처리하여야 하며, 신속한
									처리가 곤란한 경우 그 사유와 처리 일정을 서비스 화면에 게재하거나 메일 등을 통하여 회원에게 통지합니다.</li>
							</ol>
							...
							<ol>
								<li>회원은 다음 행위를 하여서는 안됩니다.
									<ol>
										...
										<li>외설 또는 폭력적인 메시지,화상,음성,기타 공서양속에 반하는 정보를 회사에 공개 또는 게시하는
											행위</li>
										<li>회사의 동의 없이 영리를 목적으로 서비스를 사용하는 행위</li>
										<li>기타 불법적이거나 부당한 행위</li>
									</ol>
								</li>
								<li>회원은 관계법, 본 약관의 규정, 이용안내 및 서비스와 관련하여 공지한 주의사항, 회사가 통지하는
									사항 등을 준수하여야 하며, 기타 회사의 업무에 방해되는 행위를 하여서는 안됩니다.</li>
								<li>회원은 회사에서 공식적으로 인정한 경우를 제외하고는 서비스를 이용하여 상품을 판매하는 영업 활동을
									할 수 없으며, 특히 해킹, 광고를 통한 수익, 음란사이트를 통한 상업행위, 상용소프트웨어 불법배포 등을 할 수
									없습니다. 이를 위반하여 발생한 영업 활동의 결과 및 손실, 관계기관에 의한 구속 등 법적 조치 등에 관해서는
									회사가 책임을 지지 않으며, 회원은 이와 같은 행위와 관련하여 회사에 대하여 손해배상 의무를 집니다.</li>
							</ol>
							<p class="private_list_title">제14조[서비스의 제공]</p>
							<ol>
								<li>회사는 회원에게 아래와 같은 서비스를 제공합니다.
									<ol>
										<li>투어팁스: 정보 또는 자료의 관리/저장/공유를 위한 여행관련 정보 서비스</li>
										<li>기타 회사가 추가 개발하거나 다른 회사와의 제휴 계약 등을 통해 회원에게 제공하는 일체의 서비스
											(기존 서비스를 활용하기 위한 API서비스 등 포함)</li>
										<li>직접 판매하는 재화 또는 용역 등에 대한 정보 제공 및 계약의 체결 및 계약이 체결된 재화 또는
											용역 등의 배송</li>
									</ol>
								</li>
								<li>회사는 서비스를 일정 범위로 분할하여 각 범위별로 이용 가능 시간을 별도로 지정할 수 있습니다.
									다만 이러한 경우에는 그 내용을 사전에 공지합니다.</li>
							</ol>
							<p class="private_list_title">제15조[서비스의 변경]</p>
							<ol>
								<li>회사는 상당한 이유가 있는 경우에 운영상, 기술상의 필요에 따라 제공하고 있는 전부 또는 일부
									서비스를 변경할 수 있습니다.</li>
								<li>서비스의 내용, 이용방법, 이용시간에 대하여 변경이 있는 경우에는 변경사유, 변경될 서비스의 내용
									및 제공일자 등은 그 변경 전 7일 이상 해당 서비스 초기화면에 게시하여야 합니다.</li>
							</ol>
							<p class="private_list_title">제16조[정보의 제공 및 광고의 게재]</p>
							<ol>
								<li>회사는 회원이 서비스 이용 중 필요하다고 인정되는 다양한 정보를 공지사항이나 이메일 등의 방법으로
									회원에게 제공할 수 있습니다. 다만, 회원은 관련법에 따른 거래관련 정보, 고객센터 답변 등을 제외하고 언제든지
									이메일 등을 통하여 수신 거절을 할 수 있습니다.</li>
								<li>제2항의 정보를 전화 및 모사전송기기에 의하여 전송하려고 하는 경우에는 회원의 사전 동의를 받아서
									전송합니다.</li>
								<li>회사는 서비스의 운영과 관련하여 서비스 화면, 홈페이지,이메일 등에 광고를 게재할 수 있습니다.
									광고가 게재된 이메일을 수신한 회원은 수신거절을 회사에게 할 수 있습니다.</li>
							</ol>
							<p class="private_list_title">제17조[게시물의 저작권]</p>
							<ol>
								<li>회원이 서비스 내에 게시한 게시물의 저작권은 해당 게시물의 저작자에게 귀속됩니다.</li>
								<li>회원이 서비스 내에 게시하는 게시물은 검색결과 내지 서비스 및 관련 프로모션 등에 노출될 수
									있으며, 해당 노출을 위해 필요한 범위 내에서는 일부 수정, 복제, 편집되어 게시될 수 있습니다. 이 경우,
									회사는 저작권법 규정을 준수하며, 회원은 언제든지 고객센터 또는 서비스 내 관리 기능을 통해 해당 게시물에 대해
									삭제, 검색결과 제외, 비공개 등의 조치를 취할 수 있습니다.</li>
								<li>회원이 서비스 내에 게시하는 게시물은 가이드북과 맵북 서비스에 노출될 수 있으며, 해당 노출을 위해
									필요한 범위 내에서는 일부 수정, 복제, 편집되어 게시될 수 있습니다. 또한 게시물이 노출된 가이드북과 맵북,
									서비스는 제3자에게 제공될 수 있으며 이때 발생되는 수익은 회원에게 돌려주지 않습니다.</li>
								<li>회사는 제2항 이외의 방법으로 회원의 게시물을 이용하고자 하는 경우에는 전화,팩스,이메일 등을 통해
									사전에 회원의 동의를 얻어야 합니다.</li>
							</ol>
							<p class="private_list_title">제18조[게시물의 관리]</p>
							<ol>
								<li>회원의 게시물이 정보통신망법 및 저작권법 등 관련법에 위반되는 내용을 포함하는 경우, 권리자는
									관련법이 정한 절차에 따라 해당 게시물의 게시 중단 및 삭제 등을 요청할 수 있으며, 회사는 관련법에 따라 조치를
									취하여야 합니다.</li>
								<li>회사는 다음 각 호에 해당하는 게시물이나 자료를 사전 동의없이 삭제하거나 이동 또는 등록 거부를 할
									수 있습니다.</li>
								<ol>
									...
									<li>사적인 정치적 판단이나 종교적 견해의 내용으로 회사의 서비스 성격에 부합하지 않는다고 판단되는
										경우</li>
									<li>회사에서 규정한 게시물 원칙에 어긋나거나, 근거없는 비방 등, 게시판 성격에 부합하지 않는다고
										회사가 판단한 경우</li>
							...
							<ol>
								<li>서비스에 대한 저작권 및 지적재산권은 회사에 귀속됩니다. 단, 회원의 게시물 및 제휴계약에 따라
									제공된 저작물 등은 제외합니다.</li>
								<li>회사는 서비스와 관련하여 회원에게 회사가 정한 이용조건에 따라 계정, 아이디, 콘텐츠 등을 이용할
									수 있는 이용권만을 부여하며, 회원은 이를 양도, 판매, 담보제공 등의 처분행위를 할 수 없습니다.</li>
							</ol>
							<p class="private_list_title">제20조[“회원”의 계약 해제, 해지 등]</p>
							<ol>
								<li>회원은 언제든지 자기 정보 관리 메뉴를 통하여 서비스 탈퇴 신청을 할 수 있으며, 회사는 관련법
									등이 정하는 바에 따라 이를 즉시 처리하여야 합니다.</li>
								<li>회원이 계약을 해지할 경우, 관련법 및 개인정보보호정책에 따라 회사가 회원정보를 보유하는 경우를
									제외하고는 해지 즉시 회원의 모든 데이터는 소멸됩니다.</li>
								<li>회원이 계약을 해지하였으나 본인 계정에 등록하고 공개된 데이터는 보존됩니다.</li>
							</ol>
							<p class="private_list_title">제21조[이용제한 등]</p>
							<ol>
								<li>회사는 회원이 본 약관의 의무를 위반하거나 서비스의 정상적인 운영을 방해한 경우, 서비스 이용을
									경고, 일시정지, 계약해지로 단계적으로 제한할 수 있습니다.</li>
								<li>회사는 전항에도 불구하고, 저작권법 및 컴퓨터프로그램보호법을 위반한 불법프로그램의 제공 및 운영
									방해, 정보통신방법을 위반한 불법통신 및 해킹, 악성프로그램의 배포, 접속권한 초과행위 등과 같이 관련법을 위반한
									경우에는 즉시 계약해지를 할 수 있습니다. 본 항에 따른 계약해지 시 서비스 이용을 통해 획득한 혜택 등도 모두
									소멸되며, 회사는 이에 대해 별도로 보상하지 않습니다.</li>
								<li>회사는 회원이 계속해서 3개월 이상 로그인하지 않는 경우, 회원정보의 보호 및 운영의 효율성을 위해
									이용을 제한할 수 있습니다.</li>
								<li>본 조에 따라 서비스 이용을 제한하거나 계약을 해지하는 경우에는 회사는 제11조[”회원”에 대한
									통지]에 따라 통지합니다.</li>
								<li>회원은 본 조에 따른 이용제한 등에 대해 회사가 정한 절차에 따라 이의신청을 할 수 있습니다. 이때
									이의가 정당하다고 회사가 인정하는 경우 회사는 즉시 서비스의 이용을 재개합니다.</li>
							</ol>
							<p class="private_list_title">제22조[구매신청]</p>
							<span>회사 이용자는 회사에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, 회사는 사용자가
								구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다. 단, 회원인 경우 제 2호 내지 제 4호의
								적용을 제외할 수도 있습니다.</span>
							<ol>
								<li>재화 등의 검색 및 선택</li>
							...
							<ol>
								<li>회사는 제22조와 같은 구매신청에 대하여 다음 각 호에 해당하면 승낙하지 않을 수 있습니다.</li>
								<ol>
									<li>신청내용에 허위, 기재누락, 오기가 있는 경우</li>
									<li>신용카드 결제 시 소유주의 동의를 얻지 않는 불법행위로 추정 또는 확인되었을 경우</li>
								</ol>
								<li>회사는 계약이 체결되었음을 문자(카카오톡) 혹은 전자우편을 통하여 이용자에게 안내하며 이용자에게
									안내한 시점에 계약이 성립한 것으로 봅니다.</li>
							</ol>

							<p class="private_list_title">제24조[대금지급방법]</p>
							<span>회사에서 구매한 재화 또는 용역에 대한 대금지급은 다음 각 호의 방법 중 회사가 지정하는
								방식으로 이루어집니다. </span>
							<ol>
								<li>실시간 계좌이체</li>
							...
							<ol>
								<li>회사는 이용자의 구매신청이 있는 경우 이용자에게 문자(카카오톡) 혹은 전자우편으 로 계약의 체결을
									알립니다.</li>
								<li>이용자는 의사표시의 불일치 등이 있는 경우에는 통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할
									수 있고 회사는 지체 없이 그 요청에 따라 처리하여야 합니다. 다만, 회사가 중개하는 현지 여행업체에게 이미
									대금을 지불하였거나 예약이 완료된 경우에는 제28조의 청약철회 등에 관한 규정에 따릅니다. 이용자 본인의 실수,
									누락 등의 개인적인 사유로 인하여 이용일 이후 구매신청 변경 및 취소를 원하는 경우 회사는 이를 인정하지 않을 수
									있습니다.</li>
							</ol>

							<p class="private_list_title">제26조[재화 등의 공급]</p>
							<ol>
								<li>회사는 이용자와 재화 등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터
									7 일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 취합니다. 다만, 회사가 이미 재화
									등의 대금의 전부를 받은 경우에는 대금의 전부를 받은 날부터 3 영업일 이내에 조치를 취합니다. 이때 회사는
									이용자가 재화 등의 공급 및 진행사항을 확인할 수 있도록 적절한 조치를 합니다.</li>
							...
							<span>회사는 이용자가 구매신청 한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는
								지체 없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 3 영업일
								이내에 환급하거나 환급에 필요한 조치를 취합니다. 다만, 여행 상품의 특성 상 각 개별 상품의 계약체결 시 계약한
								취소 환불 규정에 의거 상품의 취소 및 환불 수수료를 공제 후 환불 합니다.</span>

							<p class="private_list_title">제28조[청약철회 등]</p>
							<ol>
								<li>회사와 재화 등의 구매에 관한 계약을 체결한 이용자는 수신확인의 통지를 받은 날부터 7 일 이내에는
									청약의 철회를 할 수 있습니다. 다만, 여행상품의 경우 계약시 체결한 각 개별 취소 환불 규정을 따릅니다.</li>
								<li>이용자는 재화 등을 배송 받은 경우 다음 각 호의 경우에는 청약철회 및 교환을 할 수 없습니다.</li>
								<ol>
									<li>이용자에게 책임 있는 사유로 재화 등이 멸실 또는 훼손된 경우 (다만, 재화 등의 내용을 확인하기
										위하여 포장 등을 훼손한 경우에는 사전에 청약철회 제한에 관해 고지하지 않은 한 청약철회 등을 할 수
										있습니다.)</li>
									...
									<li>제 2 항 제 2 호 내지 제 5 호의 경우에 회사가 사전에 청약철회 등이 제한되는 사실을
										소비자가 쉽게 알 수 있는 곳에 명기하거나 시용상품을 제공하는 등의 조치를 하지 않았다면 이용자의 청약철회 등이
										제한되지 않습니다.</li>
									<li>이용자는 제 1 항 및 제 2 항의 규정에 불구하고 재화 등의 내용이 광고 내용과 다르거나
										계약내용과 다르게 이행된 때에는 당해 재화 등을 공급 받은 날부터 3 월 이내, 그 사실을 안 날 또는 알 수
										있었던 날부터 30 일 이내에 청약철회 등을 할 수 있습니다</li>
								</ol>
							</ol>

							<p class="private_list_title">제29조[청약철회 등의 효과]</p>
							<span>여행상품의 경우에는 각 개별 여행계약의 환불 규정을 따르고, 그렇지 아니한 경우에는 아래 각
								호의 규정에 의합니다. </span>
							<ol>
								<li>회사는 이용자로부터 재화 등을 반환 받은 경우 3 영업일 이내에 이미 지급 받은 재화 등의 대금을
									환급합니다. 이 경우 회사가 이용자에게 재화 등의 환급을 지연한 때에는 그 지연기간에 대하여 전자상거래 등에서의
									소비자보호에 관한 법률 시행령이 정하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.</li>
								<li>회사는 위 대금을 환급함에 있어서 이용자가 신용카드 또는 전자화폐 등의 결제수단으로 재화 등의
							...
							<ol>
								<li>회사는 회사의 고의나 중대한 과실로 인하여 이용자나 제3자에게 발생한 손해에 대하여만, 이용자가
									회사에 지급한 수수료, 물품대금 등의 범위 내에서만 배상합니다.</li>
								<li>이용자가 이 약관의 규정을 위반함으로 인하여 회사에 손해가 발생하게 되는 경우, 이 약관을 위반한
									이용자는 회사에 발생하는 모든 손해를 배상하여야 합니다.</li>
								<li>회사는 다음 각 호의 경우에는 면책됩니다.</li>

								<li>회사는 천재지변, 전쟁 및 기타 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는
									서비스 제공에 대한 책임이 면제됩니다.</li>
								<li>회사는 기간통신 사업자가 전기통신 서비스를 중지하거나 정상적으로 제공하지 아니하여 손해가 발생한
									경우 책임이 면제됩니다.</li>
								<li>회사는 서비스용 설비의 보수, 교체, 정기점검, 공사 등 부득이한 사유로 발생한 손해에 대한 책임이
									면제됩니다.</li>
								<li>회사는 이용자의 귀책사유로 인한 서비스 이용의 장애 또는 손해에 대하여 책임을 지지 않습니다.</li>
								<li>회사는 이용자의 컴퓨터 오류에 의해 손해가 발생한 경우, 또는 이용자가 개인정보 및 전자우편주소를
									부실하게 기재하여 손해가 발생한 경우 책임을 지지 않습니다.</li>
								<li>회사는 이용자가 서비스를 이용하여 기대하는 수익을 얻지 못하거나 상실한 것에 대하여 책임을 지지
									않습니다.</li>
								<li>회사는 이용자가 서비스를 이용하면서 얻은 자료로 인한 손해에 대하여 책임을 지지 않습니다. 또한
									회사는 이용자가 서비스를 이용하며 타 이용자로 인해 입게 되는 정신적 피해에 대하여 보상할 책임을 지지 않습니다.</li>
								<li>회사는 이용자가 당사에 게재한 각종 정보, 자료, 사실의 신뢰도, 정확성 등 내용에 대하여 책임을
									지지 않습니다.</li>
								<li>회사는 이용자 상호간 및 이용자와 제 3자 상호 간에 서비스를 매개로 발생한 분쟁에 대해 개입할
									의무가 없으며, 이로 인한 손해를 배상할 책임도 없습니다. 다만 회사는 내부 지침에 따라서 분쟁의 해결을 위한
									중재를 제안하거나, 자율 분쟁 조정 센터를 운영할 수 있습니다.</li>
								<li>회사에서 이용자에게 무료로 제공하는 서비스의 이용과 관련해서는 어떠한 손해도 책임을 지지 않습니다.</li>
							</ol>

							<p class="private_list_title">제31조[분쟁 조정 및 관할 법원]</p>
							<ol>
								<li>회원은 게시물과 관련된 저작권 침해, 명예훼손 또는 개인정보 및 서비스 이용과 관련된 사항에 관한
									문제제기 또는 문제해결은 회사가 운영하는 고객센터를 통하여 처리하여야 합니다.</li>
								<li>회사와 회원간 서비스 이용과 관련하여 발생한 분쟁에 대한 소송을 제기하는 경우에는 민사소송법상의
									법원을 관할법원으로 합니다.</li>
							</ol>

							<p>부칙</p>
							<p>본 이용약관은 2016년 11월 7일부터 적용되며, 2016년 1월 18일부터 적용되던 종전약관은 본
								약관으로 대체됩니다. 개정된 이용약관의 적용일자 이전 가입자 또한 개정된 이용약관의 적용을 받습니다.</p>
				...
				<div class="nlogin_policy_wrap last">
					...
					<div class="policy_content_wrap">
						<div class="policy_content">
							<p class="private_policy_title">투어팁스는 아래의 목적으로 개인정보를 수집 및
								이용하며, 회원의 개인정보를 안전하게 취급하는데 최선을 다합니다.</p>
							<br>
							<ol>
								<li>수집목적 : 이용자 식별, 원활한 의사소통, 부정 이용 시 제재 및 기록, 회원제 서비스 제공
									(커뮤니티, 이벤트, 여행정보 제공 참여), 유료 서비스 이용 시 요금 정산, 신규 서비스 개발, 이벤트 행사 시
									정보 전달, 마케팅 및 광고 등에 활용, 서비스 이용 기록 및 통계 분석을 통한 서비스 개선 및 맞춤형 서비스
									제공, 프라이버시 보호 측면의 서비스 환경 구축</li>
								<li>수집항목(필수) : 아이디(이메일), 비밀번호, 닉네임(별명), 생년월일, 성별</li>
								<li>수집항목(선택) : 자주쓰는 이메일, 프로필 사진, 휴대전화, 주소</li>
								<li>보유기간 : 수집된 정보는 회원탈퇴 후 지체없이 파기됩니다. 서비스 제공을 위해 필요한 최소한의
									개인정보이므로 동의를 해 주셔야 서비스 이용이 가능합니다.<br> 더 자세한 내용에 대해서는 <a
									href="/ap/serviceinfo/personal/" target="_blank"
									style="text-decoration: underline">개인정보처리방침</a>을 참고하시기 바랍니다.
								</li>
							</ol>
						</div>
					</div>
