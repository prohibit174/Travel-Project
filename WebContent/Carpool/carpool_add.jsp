										...
										<tr>
											<td colspan="2" colspan="2">
												<div class="nlogin_form_section nlogin_form_text">
													<label for="join_email_id">출발일시</label>
													...
													<div class="nlogin_select" id="emailHost">
														<p data-value="choice"><span>선택하세요</span></p>
														<ul>
																														<li><a href="#" data-value="naver.com">naver.com</a></li>
																														<li><a href="#" data-value="hanmail.net">hanmail.net</a></li>
																														<li><a href="#" data-value="nate.com">nate.com</a></li>
																														<li><a href="#" data-value="gmail.com">gmail.com</a></li>
																														<li><a href="#" data-value="hotmail.com">hotmail.com</a></li>
																														<li><a href="#" data-value="daum.net">daum.net</a></li>
																														<li><a href="#" data-value="korea.kr">korea.kr</a></li>
																														<li><a href="#" data-value="empal.com">empal.com</a></li>
																														<li><a href="#" data-value="dreamwiz.com">dreamwiz.com</a></li>
																														<li><a href="#" data-value="paran.com">paran.com</a></li>
																														<li><a href="#" data-value="yahoo.co.kr">yahoo.co.kr</a></li>
																														<li><a href="#" data-value="korea.com">korea.com</a></li>
																														<li><a href="#" data-value="yahoo.com">yahoo.com</a></li>
																														<li><a href="#" data-value="empas.com">empas.com</a></li>
																														<li><a href="#" data-value="chol.com">chol.com</a></li>
																														<li><a href="#" data-value="custom">직접입력</a></li>
														</ul>
													</div>
												</div>
										...
										<tr>
											<td colspan="2">
												<div class="nlogin_form_section nlogin_form_text">
													...
													<input type="password" name="join_pw" id="join_pw" title="비밀번호"/>
												</div>
												<div class="nlogin_form_section nlogin_form_text">
													<label class="join_rpw_label" for="join_rpw">비밀번호확인</label>
													<input type="password" name="join_rpw" id="join_rpw" title="비밀번호 확인"/>
												</div>
												<span class="nlogin_pass_info" id="join_pw_helper">영문, 숫자, 특수문자 포함 8~20자 내외</span>
											</td>
										</tr>
										<tr>
											<td colspan="2">
												<div class="nlogin_form_section nlogin_form_text">
													<label for="login_name">닉네임(별명)</label>
													<input type="text" name="join_name" id="join_name" title="닉네임(별명)" maxlength="20" />
												</div>
												<span class="nlogin_pass_info" id="join_name_helper">한글 1~10,영문,숫자,특수문자(!@#$%^&*) 2~20 (혼용 가능)</span>
											</td>
										</tr>
										<tr>
